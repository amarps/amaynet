...
C_CONN::Connection(TCP *_server) : server(_server), connection_droped(false)
{
...
std::forward_list<TCP *>::iterator C_CONN::iter() const { return _iter; }

std::forward_list<TCP *>::iterator C_CONN::end() { return _conn_list.end(); }
...
bool C_CONN::Ready() { return FD_ISSET(data()->GetFD(), &_reads); }
