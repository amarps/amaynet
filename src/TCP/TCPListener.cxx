...
TCPListener::TCPListener()
    : _listen_size(default_listen_size), m_connection(this)
{
}

TCPListener::TCPListener(const std::string &port, int listen_size)
    : TCP(port, 0), _listen_size(listen_size), m_connection(this)
{
}
...
TCP *TCPListener::Accept()
{
  ...
  int newfd =
      accept(GetFD(), (struct sockaddr *)&client_addr, &client_addr_len);
