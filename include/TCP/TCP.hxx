...
public:
   ...
   * @return message
   */
  virtual std::vector<char> Recv(size_t buf_size = _default_recv_size);
...
protected:
  ...
  std::vector<char> RecvSSL(size_t buf_size = _default_recv_size);
  std::vector<char> RecvTCP(size_t buf_size = _default_recv_size) const;
